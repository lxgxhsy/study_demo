...
Metrics reset clears cumulative counters only. It does not fake real-time values such as active thread count or queue size.
...
3. Return the order ID plus async accepted/rejected counts.
